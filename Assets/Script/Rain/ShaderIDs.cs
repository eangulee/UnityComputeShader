...
public static class ShaderIDs
{
    ...
    public static int matrixBuffer = Shader.PropertyToID("matrixBuffer");
    public static int timeSliceBuffer = Shader.PropertyToID("timeSliceBuffer");
    public static int _DeltaFlashSpeed = Shader.PropertyToID("_DeltaFlashSpeed");
}
